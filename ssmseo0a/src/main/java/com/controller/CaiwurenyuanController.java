...
public class CaiwurenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		CaiwurenyuanEntity user = caiwurenyuanService.selectOne(new EntityWrapper<CaiwurenyuanEntity>().eq("caiwuzhanghao", username));
    ...
    public R register(@RequestBody CaiwurenyuanEntity caiwurenyuan){
    	...
    	CaiwurenyuanEntity user = caiwurenyuanService.selectOne(new EntityWrapper<CaiwurenyuanEntity>().eq("caiwuzhanghao", caiwurenyuan.getCaiwuzhanghao()));
		if(user!=null) {
